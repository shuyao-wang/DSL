...
# Decay Schedule:  CosineDecay & LinearDecay
...
class Masking(object):
    ...
    def step(self):
        ...
        self.optimizer.step()   #更新weight

        self.apply_mask()       #每个step对更新后weight添加mask
        
        self.death_rate_decay.step()    #prune的update schedule
        self.death_rate = self.death_rate_decay.get_dr()
        #pdb.set_trace()
        self.steps += 1
        #self.prune_every_k_steps:delta_T
        #self.steps: t
    ...
    def add_module(self, module, density, sparse_init='ER'):
        ...
        self.remove_weight_partial_name('linear')     #移除self.masks中的bias项，移除self.name中的bias项
        self.remove_weight_partial_name('predict')
        self.remove_weight_partial_name('gmf')
        self.remove_weight_partial_name('conv')
        # self.remove_weight_partial_name('emb_MF')
    ...
    def remove_weight_partial_name(self, partial_name):
        #pdb.set_trace()
        removed = set()
        for name in list(self.masks.keys()):        #移除mask bias weight
